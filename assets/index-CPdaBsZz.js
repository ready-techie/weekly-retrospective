...
function requireDist() {
  ...
  function startIndex(str, index2, max) {
    do {
      const code2 = str.charCodeAt(index2);
      if (code2 !== 32 && code2 !== 9)
        return index2;
    } while (++index2 < max);
    return max;
...
function ViewPost() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: post.content })
  ] });
}
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        path: "/",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: posts.map((post, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/${encodeURIComponent(post.filePath)}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          post.date.format("YYYY-MM-DD"),
          " ",
          post.player
        ] }) }) }, index2)) })
